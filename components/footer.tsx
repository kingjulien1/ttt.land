...
export default function Footer() {
  return (
    <footer className="p-4 sm:p-6 bg-violet-500 bg-opacity-10">
      <div className="md:flex md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="text-gray-600 dark:text-gray-400">
              <li className="mb-4">
                <Link href="https://github.com/kingjulien1">
          ...
          <div>
            ...
            <ul className="text-gray-600 dark:text-gray-400">
              <li className="mb-4">
                <Link href="https://github.com/kingjulien1/ttt.land">
      ...
      <hr className="my-6 border-purple-200 sm:mx-auto dark:border-purple-900 dark:border-opacity-25 lg:my-8" />
      <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © 2022{" "}
          <Link href="/">
            <a className="hover:underline">ttt.land™</a>
          </Link>
          . All Rights Reserved.
        </span>
