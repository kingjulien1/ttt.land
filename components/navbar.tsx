    ...
    <nav className="bg-white px-4 sm:px-4 py-2.5 dark:bg-black fixed w-full z-20 top-0 left-0 border-b border-purple-200 dark:border-purple-600 dark:border-opacity-25">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="flex md:order-2 space-x-2 md:space-x-4">
          ...
          <button
            type="button"
            className="text-white bg-violet-700 hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:focus:ring-blue-800"
          >
            Join
          </button>
          <button
