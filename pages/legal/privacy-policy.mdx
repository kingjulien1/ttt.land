...
If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please _[contact us](https://github.com/kingjulien1/trampstamp.network/discussions/new?category=feedback)_.

## Children's Information

Another part of our priority is adding protection for children while using the internet. Tattoos are meant for adults, and adults only. That is why we strongly encurage parents and guardians to
