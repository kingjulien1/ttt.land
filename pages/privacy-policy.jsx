    ...
    <Container sm css={{ textAlign: "center", p: 0 }}>
      <Grid.Container gap={6} justify="center" css={{ width: "100%", my: 40, mx: 0, px: 4, textAlign: "center" }}>
        <Grid>
          ...
          <Text>
            At Tattoo Land, accessible from <Link href="/">ttt.land</Link>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that
            is collected and recorded by Tattoo Land and how we use it. If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us. This
            Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Tattoo Land. This policy is
            not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the Free Privacy Policy Generator.
          </Text>
        </Grid>
        <Grid>
          <Text h2>Consent</Text>
          <Text>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</Text>
        </Grid>
        <Grid>
          <Text h2>Information we collect</Text>
          <Text>
        ...
        <Grid>
          <Text h2>How we use your information</Text>
          ...
          <ul style={{ listStyleType: "inherit", display: "table", margin: "0 auto", marginTop: 20, textAlign: "start" }}>
            ...
            <li>
              Communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the website, and for
        ...
        <Grid>
          <Text h2>Log Files</Text>
          <Text>
            Tattoo Land follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services&apos;
            analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and
            possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site,
            tracking users&apos; movement on the website, and gathering demographic information.
          </Text>
        </Grid>
        <Grid>
          <Text h2>Cookies and Web Beacons</Text>
          <Text>
        ...
        <Grid>
          <Text h2>Advertising Partners Privacy Policies</Text>
          <Text>You may consult this list to find the Privacy Policy for each of the advertising partners of Tattoo Land.</Text>
          <Text>
            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on Tattoo Land,
        ...
        <Grid>
          ...
          <Text>
            Tattoo Land&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for
        ...
        <Grid>
          <Text h2>CCPA Privacy Rights (Do Not Sell My Personal Information)</Text>
        ...
        <Grid>
          <Text h2>Children&apos;s Information</Text>
          <Text>
          ...
          <Text>
            Tattoo Land does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our
